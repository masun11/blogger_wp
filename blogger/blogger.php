...
function load_css_js() {
  if(is_page('blogger-registration') ){
    ...
    wp_enqueue_style( 'blogger-css', plugin_dir_url(__FILE__) . 'assets/style.css', false, NULL, 'all' );
  }
}
...
if(!function_exists('wp_get_current_user')) {
  ...
  ################# Disable showing posts and media of other WordPress users ################
  ...
  ################# Post status pending which was create or update by author ################
